---
title: "DATA CASE：The Old Faithful "
output: 
...
### ⏱ **Estimating Probability**  {data-width=30%}
```{r}
...
Row {data-height=25%}
-------------------------------------
### 🚴 **Prob. Dist. Func. (PDF)** {data-width=20%}
```{r}
...
### 🚴 **Cumulative Dist. Func. (CDF)** {data-width=20%}
```{r}
...
=====================================
### <span style="font-size:22px">`r "\U1F5FF"` Discussion：</span>  {data-height=250}
<p class="qiz">
...
&emsp;■ Whether to place the game or not?<br>
&emsp;■ If you join the game, which time period would you choose?<br>
&emsp;■ In the period you'd chosen, what is the expected value of the game?<br>
<br>
...
&emsp;■ For the maximum expected value, how would you place your bets?<br>
&emsp;■ What is the overall expected value of your bets?<br>
<br>
...
&emsp;■ What is the strategy to maximize the Expected ROI?<br>
&emsp;■ Is the strategy for maximal Expected ROI the same as that of maximal Expected Return?<br>
&emsp;■ Which of the two strategic objectives is better? and Why?  <br>
<br>
</p class="qiz">
...
-------------------------------------
### 🌷 <b>The Output of Simulation</b> {data-height=52%}
...
### ⛓ <b>Model：PDF & CDF</b> {data-height=10%}
...
### ⛓ <b>Data Processing Pipeline</b> {data-height=38%}
<p style="font-family:'Consolas'; font-size:11px; 
color:#00c000; background:#000000;
border-left:12px solid #cce6ff; padding:4px; padding-left:10px;">
...
-------------------------------------
### 🎲 <b>Strategy Space</b>  {data-height=60%}
```{r}
renderPlot({
...
<p class="wwl">
<span style="font-size:14px">`r "\U1F36D"` <b>Strategy Space：</b></span><br>
&emsp; ■ Every point is a <z>Strategy</z> <br>
&emsp; ■ Each dimension is a <z>Performance Index</z> <br>
&emsp; ■ The ideas of <z>Efficiency Frontier</z> & <z>Reasonable Strategies</z><br>
</p class="wwl">

<p class="wwl">
<span style="font-size:14px">`r "\U1F36D"` <b>Tradeoff and Constraints：</b></span><br>
&emsp; ■ If there's no constraints, what is the optimal strategy？<br>
&emsp; ■ What if you have a capital limitation at `c_invest < 40`？<br>
&emsp; ■ What if you have another investment opportunity with `ROI = 62.5%`？<br>
</p class="wwl">
...
<p class="wwl">
■ The Concept of Distribution and Model<br>
■ The Concepts of Model Forms and Model Parameters<br>
■ The Trade off between Sensibility & Generality<br>
■ Selecting model(s) and setting argument(s)<br>
■ Analytics: Data, Stat., Visual, Model, Predict, Simulate, Optimize<br>
■ Analytics process as a Data Pipeline<br>
■ Analytics: Data, Stat., Visual, Model, Predict, Simulate, Optimize<br>
■ Strategy making is a communication process<br>
■ Strategy Space is very helpful in making decision<br>
</p class="wwl">
