...
犯罪是一個國際關注的問題，但它在不同的國家以不同的方式記錄和處理。 在美國，聯邦調查局（FBI）記錄了暴力犯罪和財產犯罪。 此外，每個城市都記錄了犯罪行為，一些城市發布了有關犯罪率的數據。 伊利諾伊州芝加哥市從2001年開始在線發布犯罪數據。 芝加哥是美國人口第三多的城市，人口超過270萬。 在這個作業裡面，我們將關注一種特定類型的財產犯罪，稱為「汽車盜竊」， 我們將使用R中的一些基本數據分析來了解芝加哥的汽車盜竊紀錄。 
請用 `read.csv()` 讀進 `data/mvtWeek1.csv` 資料檔。
